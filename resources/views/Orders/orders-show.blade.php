...
@section('subcontent')
    <h2 class="intro-y text-lg font-medium mt-10">orderLayout</h2>
    <div class="col-md-12 col-sm-12 p-a-1">
        ...
        <div class="grid grid-cols-12 gap-6 mt-5">
            <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
                <a href="{{route('orders-create')}}" class="btn btn-primary shadow-md mr-2">Add New order</a>
                <div class="dropdown">
                ...
                <table class="table table-report -mt-2">
                    ...
                    @foreach ($orders as $order)
                        <tr class="intro-x">
                            ...
                            {{--                            <td class="text-center">{{ $order['stocks'][0] }}</td>--}}
                            <td class="w-40">
                                <a href="" class="font-medium whitespace-nowrap">{{ $order->user_id  }}</a>
                           </td>
